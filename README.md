# Laboratório de Desenvolvimento Multiplataforma - Atividade Avaliação 1

## Nome do Projeto: Fatec Music - Android Web

## Integrantes do Grupo 
## Nome do grupo: Cupula dos Kages
...
> ### ⚠️ Nota - Requisito F (Repositório Remoto) ⚠️
...
> !!!!!!O `google-services.json` é necessário apenas para o build Android. Desktop e Web usam apenas o `PROJECT_ID` e `API_KEY` do `RepositorioRemoto.kt`.

---
### ANTES DE EXECUTAR SINCRONIZE O GRAGLE
